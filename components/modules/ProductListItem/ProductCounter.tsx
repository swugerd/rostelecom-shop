...
import { updateCartItemsCountInLs } from '@/lib/utils/cart'
...
const ProductCounter = ({
  ...
  const currenTotalCount = +cartItem?.inStock || totalCount
  ...
  const updateCountWithRequest = (count: number) => {
    updateCartItemsCountInLs(cartItem.clientId, count)
